...
public class RnsQuotationVendorsFullDetails {
    ...
    private RnsQuotationVariantFullDetails fullDetails;

    private RnsQuotation vendorQuotation;

    private boolean remarkExist;

    private VndrPrice vndrPrice;
    ...
    public RnsQuotationVariantFullDetails getFullDetails() {
        return fullDetails;
    }

    public void setFullDetails(RnsQuotationVariantFullDetails fullDetails) {
        this.fullDetails = fullDetails;
    }

    public VndrPrice getVndrPrice() {
        return vndrPrice;
    }

    public void setVndrPrice(VndrPrice vndrPrice) {
        this.vndrPrice = vndrPrice;
    }
