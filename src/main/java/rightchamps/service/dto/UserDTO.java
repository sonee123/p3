...
public class UserDTO {
    ...
    public UserDTO(User user) {
        ...
        this.vendorCode = user.getVendorCode();
        this.vendorName = user.getVendorName();
        this.registeredUser = user.isRegisteredUser();
        this.secondaryEmail = user.getSecondaryEmail();
        this.contactNumber1 = user.getContactNumber1();
        this.contactNumber2 = user.getContactNumber2();
