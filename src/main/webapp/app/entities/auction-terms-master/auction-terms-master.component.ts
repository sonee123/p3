...
@Component({
    selector: 'jhi-auction-terms-master',
    templateUrl: './auction-terms-master.component.html'
})
export class AuctionTermsMasterComponent implements OnInit, OnDestroy {
    auctionTermsMasters: AuctionTermsMaster[];
    currentAccount: any;
    ...
    loadAll() {
        this.auctionTermsMasterService.query().subscribe(
            (res: HttpResponse<AuctionTermsMaster[]>) => {
                this.auctionTermsMasters = res.body;
                this.afterViewInit();
            },
    ...
    trackId(index: number, item: AuctionTermsMaster) {
        return item.id;
    }
