...
export class CurrencyPopupService {
    ...
    constructor(private modalService: NgbModal, private router: Router, private currencyService: CurrencyService) {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.currencyService.find(id).subscribe(currency => {
                    this.ngbModalRef = this.currencyModalRef(component, currency.body);
                    resolve(this.ngbModalRef);
                });
            } else {
