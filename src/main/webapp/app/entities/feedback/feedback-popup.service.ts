...
export class FeedbackPopupService {
    ...
    constructor(private modalService: NgbModal, private router: Router, private feedbackService: FeedbackService) {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.feedbackService.find(id).subscribe(feedback => {
                    this.ngbModalRef = this.feedbackModalRef(component, feedback.body);
                    resolve(this.ngbModalRef);
                });
            } else {
