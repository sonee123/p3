...
export class RnsPchMasterComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: RnsPchMaster) {
        return item.id;
    }
    registerChangeInRnsPchMasters() {
        this.eventSubscriber = this.eventManager.subscribe('rnsPchMasterListModification', response => {
