...
@Component({
    selector: 'jhi-rns-quotation-vendors-save-dialog',
    templateUrl: './rns-quotation-vendors-popup.component.html'
})
export class RnsQuotationVendorsSavePopupComponent {
...
@Component({
    selector: 'jhi-rns-quotation-vendors-save-popup',
    template: ''
})
export class RnsQuotationVendorsPopupSaveComponent implements OnInit, OnDestroy {
    routeSub: any;
    ...
    ngOnInit() {
        this.routeSub = this.route.params.subscribe(params => {
            this.rnsQuotationVendorsPopupService.open(RnsQuotationVendorsSavePopupComponent as Component, params['id']);
        });
    }
