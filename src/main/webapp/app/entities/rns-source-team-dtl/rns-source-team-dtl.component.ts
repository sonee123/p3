...
@Component({
    selector: 'jhi-rns-source-team-dtl',
    templateUrl: './rns-source-team-dtl.component.html'
})
export class RnsSourceTeamDtlComponent implements OnInit, OnDestroy {
    rnsSourceTeamDtls: RnsSourceTeamDtl[];
    currentAccount: any;
    ...
    loadAll() {
        this.rnsSourceTeamDtlService.query().subscribe(
            (res: HttpResponse<RnsSourceTeamDtl[]>) => {
                this.rnsSourceTeamDtls = res.body;
                this.afterViewInit();
            },
    ...
    trackId(index: number, item: RnsSourceTeamDtl) {
        return item.id;
    }
