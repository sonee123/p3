...
@Component({
    selector: 'jhi-rns-source-team-master',
    templateUrl: './rns-source-team-master.component.html'
})
export class RnsSourceTeamMasterComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.rnsSourceTeamMasterService.query().subscribe(
    ...
    trackId(index: number, item: RnsSourceTeamMaster) {
        return item.id;
    }
