...
@Component({
    selector: 'jhi-rns-tax-terms-master',
    templateUrl: './rns-tax-terms-master.component.html'
})
export class RnsTaxTermsMasterComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: RnsTaxTermsMaster) {
        return item.id;
    }
