...
@Component({
    selector: 'jhi-rns-uom-master',
    templateUrl: './rns-uom-master.component.html'
})
export class RnsUomMasterComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: RnsUomMaster) {
        return item.id;
    }
    registerChangeInRnsUomMasters() {
        this.eventSubscriber = this.eventManager.subscribe('rnsUomMasterListModification', response => {
