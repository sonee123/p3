...
export class RnsVendorRemarkDialogComponent implements OnInit {
...
export class RnsVendorRemarkPopupComponent implements OnInit, OnDestroy {
    routeSub: any;
    ...
    ngOnInit() {
        this.routeSub = this.route.params.subscribe(params => {
            if (params['id']) {
                this.rnsVendorRemarkPopupService.open(RnsVendorRemarkDialogComponent as Component, params['id']);
            } else {
                this.rnsVendorRemarkPopupService.open(RnsVendorRemarkDialogComponent as Component);
            }
        });
    }
