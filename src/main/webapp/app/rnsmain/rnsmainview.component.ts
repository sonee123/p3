...
export class RnsmainviewComponent implements OnInit {
        ...
        this.routeSub = this.route.params.subscribe(params => {
            if (params['id']) {
                ...
                this.rnsQuotationService.find(id).subscribe(rnsQuotationdata => {
                    // rnsQuotationdata.validity = this.datePipe
                    //    .transform(rnsQuotationdata.validity, 'yyyy-MM-ddTHH:mm:ss');
                    // rnsQuotationdata.auctionValidity = this.datePipe
                    //    .transform(rnsQuotationdata.auctionValidity, 'yyyy-MM-ddTHH:mm:ss');
    ...
    private convert(rnsQuotation: RnsQuotation): RnsQuotation {
        ...
        // copy.auctionValidity = this.dateUtils.toDate(rnsQuotation.auctionValidity);
